    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            ...
            //CONFIRMACION
            JOptionPane.showConfirmDialog(null, bookTitle+" comprado exitosamente del agente "+reply.getSender().getName()+" con un precio de $"+bestPrice, "FELICIDADES", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE);
            myAgent.doDelete();
         }
         else {
